...
namespace capygram.Graph.Services
{
    public class PersonServices : IPersonServices
    {
        ...
        {
            //bool isHaveRelationship = await _personRepository.IsHaveRelationShip(id, did);
        ...
        {
            var result = await _personRepository.UpdateAsync(entities as UserChangedNotificationDto);
